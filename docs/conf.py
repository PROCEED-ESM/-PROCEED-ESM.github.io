...
htmlhelp_basename = 'PROCEED-ESMdoc'
...
latex_documents = [
    (master_doc, 'PROCEED-ESM.tex', 'PROCEED-ESM Documentation',
     'Daniel McCoy', 'manual'),
]
...
man_pages = [
    (master_doc, 'PROCEED-ESM', 'PROCEED-ESM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PROCEED-ESM', 'PROCEED-ESM Documentation',
     author, 'PROCEED-ESM', 'One line description of project.',
     'Miscellaneous'),
]
...
html_context['github_user'] = 'PROCEED-ESM'
html_context['github_repo'] = 'PROCEED-ESM.github.io'
